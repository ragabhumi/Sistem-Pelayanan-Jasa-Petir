...
function convertDD2DMS(deg, //a string version of the coordinage
                        axis,//lat or lng
                        sec) { //whether or not we are going to show the seconds
        ...
        if (L.Browser.canvas && map) {
            ...
            function __draw_lat_line(self, lat_tick) {
                ...
                if (curvedLat) {
                    ...
                    for (var j=__lon_left; j<=__lon_right; j+=_lon_delta) {
                        ...
                        if (self.options.showLabel && label && _prev_p != null) {
                            if (_prev_p.x < 0 && rr.x >= 0) {
                                ...
                                ctx.fillText(convertDD2DMS(latstr, 'lat', false), 0, _y + (txtHeight/2));
                            }
                            else if (_prev_p.x <= (ww-txtWidth) && rr.x > (ww-txtWidth)) {
                                var _s = (rr.x - ww) / (rr.x - _prev_p.x);
                                var _y = rr.y - ((rr.y - _prev_p.y) * _s);
                                ctx.fillText(convertDD2DMS(latstr, 'lat', false), ww-txtWidth, _y + (txtHeight/2)-2);
                            }
                        }
                    ...
                    if (self.options.showLabel && label) {
                        ...
                        ctx.fillText(convertDD2DMS(latstr, 'lat', false), 0, _yy);
                        ctx.fillText(convertDD2DMS(latstr, 'lat', false), ww-txtWidth, _yy);
                    }
                }
            };
            ...
            function __draw_lon_line(self, lon_tick) {
                ...
                if (curvedLon) {
                    ...
                    for (var j=_lat_b; j<_lat_t; j+=_lat_delta) {
                        ...
                        if (self.options.showLabel && label && _prev_p != null) {
                            if (_prev_p.y > 8 && tt.y <= 8) {
                                ctx.fillText(convertDD2DMS(lngstr, 'lng', false), tt.x - (txtWidth/2), txtHeight);
                            }
                            else if (_prev_p.y >= hh && tt.y < hh) {
                                ctx.fillText(convertDD2DMS(lngstr, 'lng', false), tt.x - (txtWidth/2), hh-2);
                            }
                        }
                    ...
                    if (self.options.showLabel && label) {
                        ctx.fillText(convertDD2DMS(lngstr, 'lng', false), tt.x - (txtWidth/2), txtHeight+1);
                        ctx.fillText(convertDD2DMS(lngstr, 'lng', false), bb.x - (txtWidth/2), hh-3);
                    }
                }
            };
